...
if (
  window.location.origin.endsWith(".repl.co") &&
...
function create() {
  ...
  this.abilityBtn1 = this.abilitiesDiv.querySelector(
    "div#abilities button#ability-1.ability"
  );
  this.abilityBtn1.disabled = false;
  this.abilityCooldown1 = this.abilityBtn1.querySelector(
    "span.ability-cooldown"
  );
  this.abilityImg1 = this.abilityBtn1.querySelector("img.ability-img");
  this.abilityBtn2 = this.abilitiesDiv.querySelector(
    "div#abilities button#ability-2.ability"
  );
  this.abilityBtn2.disabled = false;
  this.abilityCooldown2 = this.abilityBtn2.querySelector(
    "span.ability-cooldown"
  );
  this.abilityImg2 = this.abilityBtn2.querySelector("img.ability-img");
  this.abilityBtn3 = this.abilitiesDiv.querySelector(
    "div#abilities button#ability-3.ability"
  );
  this.abilityBtn3.disabled = false;
  this.abilityCooldown3 = this.abilityBtn3.querySelector(
    "span.ability-cooldown"
  );
  this.abilityImg3 = this.abilityBtn3.querySelector("img.ability-img");
  this.abilityBtn4 = this.abilitiesDiv.querySelector(
    "div#abilities button#ability-4.ability"
  );
  this.abilityBtn4.disabled = false;
  this.abilityCooldown4 = this.abilityBtn4.querySelector(
    "span.ability-cooldown"
  );
  ...
  this.spawnPlayer = (id, data) => {
    ...
    // create sprite
    this.players[id] = this.physics.add
      .sprite(data.x, data.y, "players")
      .setDepth(4);
  ...
  this.gameEndWinners = this.gameEndScreen.querySelector(
    "div#end-screen-winners"
  );
  this.gameEndHomeBtn = this.gameEndScreen.querySelector(
    "button#end-screen-home"
  );
    ...
    this.abilitiesDiv.addEventListener("click", (e) => {
      if (e.target.matches("div#abilities button.ability")) {
        ...
        this.socket.emit("ability", ability, (resp) => {
          ...
          e.target.querySelector("span.ability-cooldown").innerText =
            Math.ceil(dv);
          this.time.delayedCall(
            dv * 1000,
            function () {
...
function update() {
  ...
  if (!this.createdObstacles) {
    ...
    for (const data of this.gameData.obstacles) {
      // create image
      const img = this.add
        .image(data.x, 366, "terrain16x16", data.frame)
        .setDepth(1);
